...
\textit{dynamic time warping}~\cite{mfcc_dtw}. Uzasadnienie wybranej funkcji celu opisane jest z rozdziale~\ref{target_function_chapter}.
...
\begin{equation}
  \forall p_i \in P \quad \forall p_i \in S, \quad -1.0 \leq p_i, s_i \leq 1.0
...
rozwiązywany jest następujący problem optymalizacyjny:
