...
Ponieważ zdefiniowane wymagania (\ref{sec:requirements}) zawierają dynamiczne modyfikowanie grafu przetwarzania sygnałów,
...
podejście 3 jest łatwiejsze do implementacji niż podejście 2.

\subsubsection{Zastosowanie \textit{procedural macros} do automatycznej generacji akcesorów struktur węzłów}
...
W implementacji grafu przetwarzania sygnałów
