\chapter{Implementacja grafu przetwarzania sygnałów}\label{dsp_graph_chapter}
...
\section{Zaimplementowane środowisko a istniejące rozwiązania}
...
\begin{figure}\label{fig:example_simple_analog_synth}
    \centering
    \includegraphics[angle=90,width=0.3\linewidth]{rys05/luthier_simple_analog.png}
    \caption{
