...
\begin{figure}[H]
    ...
    \caption{
      ...
      Czerwoną strzałką oznaczono składową harmoniczną, poprawnie odtworzoną przez algorytm optymalizacji.
...
poprawnie odtworzona jest zarówno dynamika dźwięku i składowa harmoniczna.

\subsubsection{Synteza \textit{analog modeling}}

Tutaj trzeba dodać opis i wygenerowane spektrogramy jak się już przekręci optymalizacja.
