...
% \usepackage[english]{babel} % Tutaj ważna jest kolejność atrybutów (dla pracy po polsku polish powinno być na końcu)
...
\kvpl{synteza, dźwięk, graf, optymalizacja, generatywna sztuczna inteligencja} % INFO: słowa kluczowe po polsku
\kven{synthesis, sound, audio, dsp, graph, optimisation, generative} % INFO: słowa kluczowe po angielsku
